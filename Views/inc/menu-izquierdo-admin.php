    ...
    <ul<ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="fa-solid fa-calendar-check" style="color: #ffffff;"></i><span>Reservas</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="fa-solid fa-file-upload" style="color: #ffffff;"></i><span>Subir Menú</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="fa-solid fa-bullhorn" style="color: #ffffff;"></i><span>Subir Avisos</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="fa-solid fa-inbox" style="color: #ffffff;"></i><span>Mensajes</span>
            </a>
        </li>
        </ul>
